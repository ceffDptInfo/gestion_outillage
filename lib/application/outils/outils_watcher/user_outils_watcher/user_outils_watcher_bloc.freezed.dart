...
class _$_WatchUserOutilsStarted implements _WatchUserOutilsStarted {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _WatchUserOutilsStarted);
  }
...
class _$_UserOutilsReceived implements _UserOutilsReceived {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _UserOutilsReceived &&
            (identical(other.failureOrUserOutils, failureOrUserOutils) ||
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(failureOrUserOutils);
